...
# ==========================================================================
# TEST PREAMBLE -- load shared test environment
# ==========================================================================

if (file.exists("tests/testthat/test_setup.R")) {
  source("tests/testthat/test_setup.R")
} else if (file.exists("test_setup.R")) {
  source("test_setup.R")
}
